...
<div id="right-panel" ng-style="style.main_bg">
	...
	<div id="top-bar" ng-controller="c_sidePanel">
		...
		<div class="top-bar-left">
			<a href="javascript:void(0);" class="plain-link m-left-15" onclick="javascript:window.location.href='<?php echo U('Index/index');?>'" ng-hide="device.isMobile"><i class="hs-icon-home"></i> 首页</a>
			<a href="javascript:void(0);" class="plain-link m-left-15" onclick="javascript:window.location.href='<?php echo U('Index/index');?>'" ng-show="device.isMobile"><i class="hs-icon-paper-plane"></i> Heysoo</a>
