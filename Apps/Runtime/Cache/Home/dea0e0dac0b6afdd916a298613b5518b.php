<?php if (!defined('THINK_PATH')) exit(); if(is_array($pieces)): foreach($pieces as $key=>$piece): ?><div class="piece" id="<?php echo ($piece['piece_id']); ?>">
...
<span class="piece_author"><?php echo ($piece["username"]); ?> &nbsp; &nbsp;发布于</span>
