...
<img class="user_avatar_img hs-img" src="/ThinkPHP/Public/img/me.jpg" title="点击修改头像">
</div>
...
<button class="hs-btn hs-btn-primary hs-btn-block" onclick=getPage("<?php echo U('Index/get_explore_page');?>","content",1)><i class="icon-random"></i> 探索发现</button>
...
<a href="<?php echo U('User/index',array('user'=>$piece['username']));?>" target="_blank"><img class="piece_avatar" src="/ThinkPHP/Public/img/me.jpg" title="访问他/她的主页"/></a>
</div>
...
<?php $tags = $piece['tag']; ?> 
<?php if(is_array($tags)): foreach($tags as $key=>$tag): ?><a href="javascript:hMessage('该功能尚未实现！',3000);" class="tag" style="text-decoration:none;"><?php echo ($tag); ?></a>&nbsp;<?php endforeach; endif; ?>
<span class="piece_footer_right"><a href="javascript:;"><i class="icon-comment-alt" title="评论"></i></a></span>
</div>
</div>
</div><?php endforeach; endif; ?>

<button type="button" class="hs-btn hs-btn-primary hs-btn-block load_more"><i class="icon-arrow-down"></i> 加载更多</button>
...
<script src="/ThinkPHP/Public/bower_components/amazeui/dist/js/amazeui.min.js"></script>
